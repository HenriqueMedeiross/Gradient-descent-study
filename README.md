...
After this, get all the *m* vectors x and transpose and stack them like this (to get a descript understand of this matrix, take a look down below at the X*theta multiplication): <img src="https://github.com/HenriqueMedeiross/Gradient-descent-study/blob/master/Equations/X-matrix.png?raw=true">
